...
MACRO(LINK_CORELIB_DEFAULT CORELIB_NAME)
    ...
    IF(OPENSCENEGRAPH_SONAMES)
      #SET_TARGET_PROPERTIES(${CORELIB_NAME} PROPERTIES VERSION ${OPENSCENEGRAPH_VERSION})
      #SET_TARGET_PROPERTIES(${CORELIB_NAME} PROPERTIES SOVERSION ${OPENSCENEGRAPH_SOVERSION})
...
MACRO(SETUP_EXAMPLE EXAMPLE_NAME)
        ...
        IF(APPLE)
            INSTALL(TARGETS ${TARGET_TARGETNAME} RUNTIME DESTINATION bin BUNDLE DESTINATION share/OpenSceneGraph/bin )
        ELSE(APPLE)
